...
| Fighters | Fighter Freezer: fighter stats, levels, decals, bags and inventories; add a new fighter into an empty freezer hanger (the way the Fighter Depot does) |
